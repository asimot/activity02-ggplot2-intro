...
PAT: "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"
---
...
**Response**: The three boxplots that represent each unique species now has a unique color to identify the individual species easier.
...
**Response**: The boxplot shows the distribution better and the correlated 5 number summary to easily see the median and quartile ranges of flipper length.  The jitter plot easily shows the individual points so that we can see each point rather than a summary of the points.
